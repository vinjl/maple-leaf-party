...
## 1b. Prototype now, national platform later

| Phase | Where the design lives | Who can propose |
|-------|------------------------|-----------------|
| **Party / design phase** | Public repository (this project) | Anyone can *read*; serious proposals follow CONTRIBUTING; this git is a **prototype**, not the end state |
| **Maple government** | **National open-government platform** under Canadian public law | **Verified Canadian citizen identity accounts only** — My Service Canada–class proof of citizenship, not foreign logins, not bots, not the world writing Canadian law |
...
4. The national platform is the official source of truth for the state design.  
